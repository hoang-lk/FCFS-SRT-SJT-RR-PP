...
public class PriorityPreemptiveLaplich extends SGKLaplich
{
    @Override
    public void process()
    {
        ...
        while (!rows.isEmpty())
        {
            ...
            Collections.sort(availableRows, (Object o1, Object o2) -> {
                if (((Hang) o1).getPriorityLevel()== ((Hang) o2).getPriorityLevel())
                {
                    return 0;
                }
                else if (((Hang) o1).getPriorityLevel() < ((Hang) o2).getPriorityLevel())
                {
                    return -1;
                }
                else
